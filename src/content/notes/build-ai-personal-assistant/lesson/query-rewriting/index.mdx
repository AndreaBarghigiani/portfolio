...
In a [previous lesson](/notes/build-ai-personal-assistant/lesson/rank-fusion/) we learned how it was possible to leverage the power of the LLM to help us generate an array of keywords that will help us searching with BM25.
