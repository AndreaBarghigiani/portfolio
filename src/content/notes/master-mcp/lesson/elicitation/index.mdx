...
```
As for the previous notes, I don't go into much details about the code that's already written, if you want to you can even check the <EL href="https://github.com/epicweb-dev/advanced-mcp-features/blob/main/exercises/02.elicitation/01.problem/src/tools.ts#L153-L170">GitHub repo for the lesson</EL>, it's free 😅 
