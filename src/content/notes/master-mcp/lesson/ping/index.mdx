...
```
We use the `console.error` especially in this case because we're in `stdio` kind of communication, that already uses the `console.log` itself and can cause some confusion.
