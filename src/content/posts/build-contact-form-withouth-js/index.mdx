...
If you open the <EL isGFE href="/interviews/study/gfe75/questions/user-interface/contact-form/react">challenge on GreatFrontEnd</EL>, you'll see that the brief includes other specs that will help you gather more information on how to solve it. However, I've listed only these three because this is where I want to focus in this article.
...
In any case, let me remember that many of the challenges in the <EL isGFE>GreatFrontEnd</EL> are free, and you're doing a disservice to yourself if you do not work on some challenges occasionally. I know this because I've done it in the past, but it's time for a change 😜
